...
  const { isAuthenticated, user, token } = useAuth(); // CRITICAL: Import useAuth to get user state
...
          ...(isAuthenticated && { 'Authorization': `Bearer ${token}` }), // Conditionally add auth header
        },
      });
