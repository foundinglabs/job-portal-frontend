...
                    <p className="text-gray-700 dark:text-gray-300 text-sm mt-1">Match: <span className="font-bold text-primary-600 dark:text-primary-400">{Number(app.match_percentage).toFixed(2)}%</span></p>
                  )}
                </div>
