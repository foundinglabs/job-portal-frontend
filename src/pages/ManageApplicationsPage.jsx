...
const ManageApplicationsPage = () => {
  ...
  if (error) {
    return <div className="flex justify-center py-10 px-4"><ErrorMessage message={error} /></div>;
  }

  return (
    <div className="flex justify-center py-10 px-4 font-inter">
      <div className="w-full max-w-5xl bg-white dark:bg-gray-900 shadow-lg rounded-xl p-6">
        ...
        <button
          ...
          className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded mb-6"
        >
        ...
        {applications.length === 0 ? (
          ...
          <div className="space-y-4">
            {applications.map((app) => (
              <div
                key={app.id}
                className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex flex-col md:flex-row justify-between items-start md:items-center"
              >
                {/* Applicant Info */}
                <div className="mb-3 md:mb-0 md:w-1/3">
                  ...
                  <p className="text-gray-500 text-xs">Applied: {new Date(app.applied_at).toLocaleDateString()}</p>
                  {app.match_percentage !== null && (
                    <p className="text-gray-700 dark:text-gray-300 text-sm mt-1">
                      Match: <span className="font-bold text-blue-600">{Number(app.match_percentage).toFixed(2)}%</span>
                    </p>
                  )}
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 md:w-2/3 md:justify-end">
                  <select
                    ...
                    className="border border-gray-300 rounded-full px-3 py-2 text-sm bg-gray-50"
                  >
                  ...
                  <button
                    ...
                    disabled={submitting && activeApplicationId === app.id}
                  >
                    {submitting && activeApplicationId === app.id
